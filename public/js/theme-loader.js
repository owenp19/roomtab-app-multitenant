(function () {
  ...
  xhr.onload = function () {
    ...
    try {
      ...
      var pc = config.primary_color || "#0B2E59";
      var sc = config.secondary_color || "#C89B3C";
      var logoUrl = config.logo_url || "";
      var brandName = config.brand_name || "";
      ...
      // Replace logo images — wait for DOM if needed
      ...
      // Inject brand name — wait for DOM if needed
